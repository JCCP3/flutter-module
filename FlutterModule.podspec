...
Pod::Spec.new do |s|
  ...
  s.description  = "Flutter Module For Flutter Build Product"

  s.homepage     = "https://github.com/JCCP3/flutter-module.git"
  ...
  s.author             = { "fanxi" => "jic920904@gmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/JCCP3/flutter-module.git", :tag => "#{s.version}" }
